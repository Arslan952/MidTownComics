...
class DVDS_Screen extends StatefulWidget {
  const DVDS_Screen({super.key});

  @override
  State<DVDS_Screen> createState() => _DVDS_ScreenState();
}

class _DVDS_ScreenState extends State<DVDS_Screen> {
  int index = 1;
