...
class GraphicNovels extends StatefulWidget {
  const GraphicNovels({super.key});

  @override
  State<GraphicNovels> createState() => _GraphicNovelsState();
}

class _GraphicNovelsState extends State<GraphicNovels> {
  int index = 1;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [
            SingleChildScrollView(child: Consumer<StreamedDataProvider>(
