...
class _NewsLetterScreenState extends State<NewsLetterScreen> {
  ...
  Widget build(BuildContext context) {
    final streamProvider =
        Provider.of<StreamedDataProvider>(context, listen: false);
    print(streamProvider.loginuserdata);
                    ...
                    Padding(
                        ...
                        Consumer<NewsLetterProvider>(
                            builder: (context, provider, child) {
                              print(provider.newsLetterDataList);
                              print(provider.newsLetterDataList.length);
                             ...
                             // print(isTrue);
                              return Theme(
                                ...
                                child: CheckboxListTile(
                                  ...
                                  title: Text(provider.newsLetterDataList[index]['nlName'],style: TextStyle(fontSize: allsize*0.012,),),
