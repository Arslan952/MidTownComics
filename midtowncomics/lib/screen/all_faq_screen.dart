...
class AllFaqScreen extends StatefulWidget {
  const AllFaqScreen({super.key});

  @override
  State<AllFaqScreen> createState() => _AllFaqScreenState();
}

class _AllFaqScreenState extends State<AllFaqScreen> {
  ...
  Widget build(BuildContext context) {
    return Theme(
      ...
      child: ExpansionTile(
        ...
        title: Text(widget.questionAnswer.question,style: const TextStyle(color: Color(0xff006ccf)),),
