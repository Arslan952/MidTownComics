...
class ActionFigureScreen extends StatefulWidget {
  const ActionFigureScreen({super.key});

  @override
  State<ActionFigureScreen> createState() => _ActionFigureScreenState();
}

class _ActionFigureScreenState extends State<ActionFigureScreen> {
  int index = 1;
