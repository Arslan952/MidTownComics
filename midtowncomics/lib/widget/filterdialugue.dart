                ...
                children: [
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      print(provider.weeklyRekease.length);
                      return Row(
                        children: [
                          Checkbox(
                          ...
                          Text(provider.weeklyRekease[index]['weekName']),
                        ],
                      );
                    },
                  ),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Row(
                        children: [
                          ...
                          Text(provider.releaseyear[index]['yearName']),
                        ],
                      );
                    },
                  ),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Row(
                        children: [
                          ...
                          Flexible(
                              child: Text(
                                  provider.series[index]['seriesTitleName'])),
                        ],
                      );
                    },
                  ),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Row(
                        children: [
                          ...
                          Flexible(
                              child: Text(provider.catagory[index]['cgName'])),
                        ],
                      );
                    },
                  ),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Row(
                        children: [
                          ...
                          Flexible(
                              child: Text(
                                  provider.discount[index]['discountName'])),
                        ],
                      );
                    },
                  ),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Row(
                        children: [
                          ...
                          Flexible(
                              child:
                                  Text(provider.artistf[index]['artistName'])),
                        ],
                      );
                    },
                  ),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Row(
                        children: [
                          ...
                          Flexible(
                              child:
                                  Text(provider.writerf[index]['writerName'])),
                        ],
                      );
                    },
                  ),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Row(
                        children: [
                          ...
                          Flexible(
                              child: Text(provider.price[index]['priceName'])),
                        ],
                      );
                    },
                  ),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Row(
                        children: [
                          ...
                          Flexible(
                              child:
                                  Text(provider.Issueno[index]['seriesName'])),
                        ],
                      );
                    },
                  ),
