...
class PreViewListView extends StatefulWidget {
  ...
  @override
  State<PreViewListView> createState() => _PreViewListViewState();
}
...
class _PreViewListViewState extends State<PreViewListView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<PreviewOrderProvider>(builder: (context, provider, child) {
      if (int.parse(provider.previewDataList[widget.index]['pr_qty'] == "0"
          ? "1"
          : provider.previewDataList[widget.index]['pr_qty']) >
          25) {
        item = FunctionClass().generateStringListFromInteger(25);
      } else {
        item = FunctionClass().generateStringListFromInteger(int.parse(
            provider.previewDataList[widget.index]['pr_qty'] == "0"
                ? "1"
                : provider.previewDataList[widget.index]['pr_qty']));
      }
      dropdownValue =
      int.parse(provider.previewDataList[widget.index]['sc_qty']) == 0
          ? "1 in Cart"
          : '${provider.previewDataList[widget.index]['sc_qty']} in Cart';
      final dateFormat = DateFormat("M/d/yyyy");
      DateTime dateTime =
      dateFormat.parse(provider.previewDataList[widget.index]['pr_reldt']);
              ...
              children: [
                Align(
                  ...
                  child: SizedBox(
                      ...
                      child: Image.network(
                        provider.previewDataList[widget.index]['hideadultimage'] == '0'
                            ? "https://www.midtowncomics.com/images/PRODUCT/FUL/${provider.previewDataList[widget.index]['pr_id']}_ful.jpg"
                ...
                Flexible(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        provider.previewDataList[widget.index]["su_id"] == "0"
                            ? Container()
                            : ClipPath(
                        ...
                        Text(
                          provider.previewDataList[widget.index]['pr_ttle'],
                          maxLines: 2,
                          softWrap: false,
                        ...
                        Row(
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                provider.previewDataList[widget.index]['mn_name'],
                                style: TextStyle(
                                    color: Colors.blue,
                                    fontSize: allsize * 0.011),
                              ),
                        ...
                        Text(
                          "\$${provider.previewDataList[widget.index]['pr_lprice']}",
                          style: TextStyle(
                              fontSize: allsize * 0.011,
                        ...
                        provider.previewDataList[widget.index]['pr_price'] ==
                            provider.previewDataList[widget.index]['pr_lprice']
                            ? Container()
                            : Padding(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      "${FunctionClass().findoff(provider.previewDataList[widget.index]['pr_price'],provider.previewDataList[widget.index]['pr_lprice'])}% OFF",
                                      style: TextStyle(
                                          color: Colors.red,
                                          fontSize: allsize * 0.012,
                                          fontWeight: FontWeight.bold),
                        ...
                        if (provider.previewDataList[widget.index]['in_cart'] ==
                            "0" ||
                            change)
                          change
                              ? const Center(
                                                ...
                                                onTap: () async {
                                                  setState(() {
                                                    if (item ==
                                                      ...
                                                      '1 in Cart';
                                                      streamprovider.call(
                                                          provider.previewDataList[
                                                          widget.index]
                                                          [
                                                          'pr_id'],
                                                          "0",
                                                          "1",provider.previewDataList[widget.index]['addedtowl']);
                                                      provider.updatePreViewList(
                                                          provider.previewDataList[
                                                          widget.index]
                                                          [
                                                          'pr_id'],
                                                  ...
                                                  http.Request(
                                                      'GET',
                                                      Uri.parse(
                                                          'https://www.midtowncomics.com/wcfmt/services/cart.svc/save?apiKey=&mtUser=&mtPass=&sh_id=${ streamedDataProvider.loginuserdata['sh_id']}&pr_id=${provider.previewDataList[widget.index]['pr_id']}&sc_qty=${item == "-Remove-" ? "0" : value1}&app_id='));
                                                  ...
                                                  streamprovider.call(
                                                      ...
                                                      "1",
                                                      value1
                                                          .toString(),provider.previewDataList[widget.index]['addedtowl']);
                                                  provider.updatePreViewList(
                                                      provider.previewDataList[
                                                      widget
                                                          .index]
                          ...
                          int.parse(provider.previewDataList[widget.index]['pr_qty'])==0?
                          InkWell(
                            onTap: (){
                              if( int.parse(provider.previewDataList[widget.index]['addedtowl'])>0)
                              {
                              ...
                              }
                              {
                                ...
                                ApiRequests().saveToWishList(streamedDataProvider.loginuserdata['sh_id']
                                    , provider.previewDataList[widget.index]['pr_parentid']);
                                streamedDataProvider.updateWishListDetail();
                                streamedDataProvider.call(provider.previewDataList[widget.index]['pr_id'],provider.previewDataList[widget.index]['in_cart'],provider.previewDataList[widget.index]['sc_qty'], "1");
                                provider.updatePreViewList(provider.previewDataList[widget.index]['pr_id'],provider.previewDataList[widget.index]['in_cart'],provider.previewDataList[widget.index]['sc_qty'],"1");
                              }
                            },
                            child: Container(
                              height: size.height * 0.06,
                              color: int.parse(provider.previewDataList[widget.index]['addedtowl'])>0?Colors.grey: Colors.red,
                              child: Center(
                                  child: Text(
                                    int.parse(provider.previewDataList[widget.index]['addedtowl'])>0?"ADDED TO WISH LIST":
                                    "ADD TO WISH LIST",
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontWeight: FontWeight.bold,
                            ...
                            onTap: () async {
                              ...
                              int quantity = int.parse(
                                  provider.previewDataList[widget.index]
                                  ['pr_qty']);
                            ...
                            child: ButtonWidget(
                              quan: provider.previewDataList[widget.index]
                              ['pr_qty'],
                              preorder:
                              provider.previewDataList[widget.index]
                              ['pr_advord'],
                                          ...
                                          return ListTile(
                                            ...
                                            onTap: () async {
                                              ...
                                              streamprovider.call(
                                                  ...
                                                  ['pr_id'],
                                                  "1",
                                                  value1.toString(),provider.previewDataList[widget.index]['addedtowl']);
                                              provider
                                                  .updatePreViewList(
                                                  provider.previewDataList[
                                                  widget
                        ...
                        provider.previewDataList[widget.index]["su_id"] == "0"
                            ? Container()
                            : provider.previewDataList[widget.index]['issubscribe'] == "0"?
                        InkWell(
                          child: Container(
                            height: size.height * 0.06,
                            decoration: BoxDecoration(
                          ...
                          onTap: ()async{
                            ...
                            if (streamedDataProvider
                              ...
                              await ApiRequests().SavePullList(
                                  streamedDataProvider
                                      .loginuserdata['sh_id'],
                                  provider.previewDataList[widget.index]['su_id'],
                                  "1",
                                  "0",
                                  provider.previewDataList[widget.index]['pr_id'],
                                  context);
